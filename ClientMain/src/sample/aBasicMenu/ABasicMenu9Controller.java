...
import sample.classes.solo.Companies;
...
public class ABasicMenu9Controller {
    ...
    @FXML
    private TableColumn<Companies, Integer> IDColumn;

    @FXML
    private TableColumn<Companies, String> infoColumn;
    ...
    void initialize(){
        ...
        btnChange.setOnAction(actionEvent -> {
            Companies selectedItem = (Companies) tableTransact.getSelectionModel().getSelectedItem();
    ...
    void doSubmit (){
        try {
            if(inputInfo.getText() == null) {
                ...
                writerObj.writeObject(ADD_COMPANY);
    ...
    public void getConnected9(Socket clientSocket, ObjectOutputStream writerObj, ObjectInputStream readerObj, Stage stage) throws IOException, ClassNotFoundException {
