...
import sample.classes.descent.SellJw;
...
public class ABasicMenu6Controller {
    ...
    @FXML
    private TableColumn<SellJw, Integer> IDColumn;

    @FXML
    private TableColumn<SellJw, Integer> userIDColumn;

    @FXML
    private TableColumn<SellJw, Date> dateColumn;

    @FXML
    private TableColumn<SellJw, Integer> sumColumn;

    @FXML
    private TableColumn<SellJw, String> firstColumn;

    @FXML
    private TableColumn<SellJw, String> secondColumn;

    @FXML
    private TableColumn<SellJw, Integer> thirdColumn;
    ...
    void initialize(){
        ...
        btnChange.setOnAction(actionEvent -> {
            SellJw selectedItem = (SellJw) tableTransact.getSelectionModel().getSelectedItem();
    ...
    public void getConnected6(Socket clientSocket, ObjectOutputStream writerObj, ObjectInputStream readerObj, Stage stage) throws IOException, ClassNotFoundException {
