...
import sample.classes.descent.RefWithd;
...
public class ABasicMenu2Controller {
    ...
    @FXML
    private TableColumn<RefWithd, Integer> IDColumn;

    @FXML
    private TableColumn<RefWithd, Integer> userIDColumn;

    @FXML
    private TableColumn<RefWithd, Date> dateColumn;

    @FXML
    private TableColumn<RefWithd, Integer> sumColumn;

    @FXML
    private TableColumn<RefWithd, String> firstColumn;

    @FXML
    private TableColumn<RefWithd, String> secondColumn;

    @FXML
    private TableColumn<RefWithd, Integer> thirdColumn;
    ...
    void initialize(){
        ...
        btnChange.setOnAction(actionEvent -> {
            RefWithd selectedItem = (RefWithd) tableTransact.getSelectionModel().getSelectedItem();
    ...
    public void getConnected2(Socket clientSocket, ObjectOutputStream writerObj, ObjectInputStream readerObj, Stage stage) throws IOException, ClassNotFoundException {
