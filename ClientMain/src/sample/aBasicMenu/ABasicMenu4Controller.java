...
import sample.classes.solo.Jwls;
...
public class ABasicMenu4Controller {
    ...
    @FXML
    private TableColumn<Jwls, Integer> IDColumn;

    @FXML
    private TableColumn<Jwls, String> infoColumn;
    ...
    void initialize(){
        ...
        btnChange.setOnAction(actionEvent -> {
            Jwls selectedItem = (Jwls) tableTransact.getSelectionModel().getSelectedItem();
    ...
    public void getConnected4(Socket clientSocket, ObjectOutputStream writerObj, ObjectInputStream readerObj, Stage stage) throws IOException, ClassNotFoundException {
